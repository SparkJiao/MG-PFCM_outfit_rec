...
logger = get_child_logger('EdgeDataset')
...
class SubgraphEdgeDataset(Dataset):
    ...
    def __getitem__(self, index) -> T_co:
        ...
        return all_dgl_graph, all_src, all_dst, all_node2re_id, all_re_id2node, list(all_nodes), quadruple
    ...
    def _load_subgraph(self, src: str, graph: Union[Dict[str, Any], str]):
        ...
        return dgl_graph, mapped_src + mapped_dst, mapped_dst + mapped_src, node2re_id, re_id2node, nodes
